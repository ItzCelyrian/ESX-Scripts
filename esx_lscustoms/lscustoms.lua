...
-- Add Garages here -> They will default to Los Santos Customs on the Map, unless you edit the function for the blips to work correctly
local garages = { 
	...
	[4] = { locked = false, camera = {x = 1177.98, y = 2636.059, z = 37.754, heading = 37.082}, driveout = {x = 1175.003,y = 2642.175, z = 37.045, heading = 0.759}, drivein = {x = 1174.701,y = 2643.764, z = 37.448, heading = 178.119}, outside = {x = 1175.565,y = 2652.819, z = 37.941, heading = 351.579}, inside = {x = 1175.29,y = 2638.65, z = 37.33, heading = 203.49}},
...
local function AddBlips()
	for i,pos in ipairs(garages) do
		...
		if i == 5 then
			...
			AddTextComponentString("~y~Beeker's Garage")
			SetBlipSprite(blip, 643)
			SetBlipColour(blip, 5)
			EndTextCommandSetBlipName(blip)
		elseif i == 6 then
			BeginTextCommandSetBlipName("STRING")
			AddTextComponentString("~y~Benny's Motorworks")
